...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            data : [
                {lable: 'Goin to lealrn React', important: true, like:false, id: '1' },   
                {lable: 'Goin to lealrn React 1', important: false, like:false, id: '2'  },
                {lable: 'Goin to lealrn React 2', important: false, like:false, id: '3' }
            ],
            term: '',
            filter: 'all'
        };
